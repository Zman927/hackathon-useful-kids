...
function RentalHistoryItem({ rental, onCancel, isCancelling }) {
  return (
      ...
      <div className="col-span-2 flex items-center justify-end gap-2">
        ...
        {rental.status === "pending" && (
          <button
            ...
            className="rounded border border-red-200 bg-red-50 px-2.5 py-1 text-xs font-medium text-red-600 transition-colors hover:bg-red-100 cursor-pointer shrink-0 disabled:cursor-not-allowed disabled:opacity-50"
          >
